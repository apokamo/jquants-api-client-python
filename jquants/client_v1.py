"""J-Quants API V1 Client (Deprecated)."""
...
from jquants import constants_v1 as constants
from jquants import enums
...
class ClientV1:
    ...
    Please migrate to ClientV2 for V2 API support.
    ...
    def __init__(
        ...
        *,
        ...
        """
        warnings.warn(
            "ClientV1 is deprecated and will be removed in a future version. "
            "Please migrate to ClientV2 for V2 API support.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _base_headers(self) -> dict:
        """
        J-Quants API header with ID token
        """
    ...
    def _get(self, url: str, params: Optional[dict] = None) -> requests.Response:
        """
        GET request wrapper with authentication header
    ...
    def get_prices_daily_quotes(
        ...
        Returns:
            pd.DataFrame: Daily quotes (sorted by Code, Date)
        """
    ...
    def get_price_range(
        ...
        """
        Get daily quotes for a date range
    ...
    def _get_prices_prices_am_raw(
        ...
        """
        get the morning session's OHLC data raw API returns
    ...
    def get_prices_prices_am(
        ...
        """
        get the morning session's OHLC data

        Args:
            code: issue code
        Returns:
            pd.DataFrame: the morning session's OHLC data
        """
    ...
    def _get_markets_trades_spec_raw(
        ...
        Args:
            ...
            from_yyyymmdd: starting point of data period
            to_yyyymmdd: end point of data period
            pagination_key: Pagination key
    ...
    def get_markets_trades_spec(
        ...
        Args:
            ...
            to_yyyymmdd: end point of data period
        Returns:
            pd.DataFrame: Weekly Trading by Type of Investors
        """
    ...
    def get_weekly_margin_range(
        ...
        """
        Get weekly margin interest for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
    ...
    def _get_markets_short_selling_raw(
        ...
        """
        get daily short sale ratios raw API returns
        """
    ...
    def get_short_selling_range(
        ...
        """
        Get short selling data for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
    ...
    def get_markets_breakdown(
        ...
        """
        get detail breakdown trading data
        """
    ...
    def get_breakdown_range(
        ...
        """
        Get breakdown data for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
    ...
    def get_statements_range(
        ...
        """
        Get financial statements for a date range
        """
        self.get_id_token()
    ...
    def get_fins_fs_details(
        ...
        """
        Get financial statement details (BS/PL)
        """
    ...
    def get_fs_details_range(
        ...
        """
        Get financial statement details for a date range
        """
        self.get_id_token()
    ...
    def get_dividend_range(
        ...
        """
        Get dividend data for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
    ...
    def _get_option_index_option_raw(
        ...
        """
        get Nikkei 225 options raw API returns
        """
    ...
    def get_index_option_range(
        ...
        """
        Get index options for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
    ...
    def get_derivatives_futures_range(
        ...
        """
        Get derivatives futures for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
    ...
    def get_derivatives_options_range(
        ...
        """
        Get derivatives options for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
    ...
    def get_markets_short_selling_positions_range(
        ...
        """
        Get short selling positions for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
    ...
    def get_daily_margin_interest_range(
        ...
        """
        Get daily margin interest for a date range
        """
        self.get_id_token()
        buff = []
        dates = pd.date_range(start_dt, end_dt, freq="D")
